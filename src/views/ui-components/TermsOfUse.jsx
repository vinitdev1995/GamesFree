...
const Terms = () => {
    ...
    return (
                ...
                <div className="block">
                    <div className="wrap">
                        ...
                        <div className="bnr_320">
                            <center>
                                <div id="div-6" style={{width: 'auto', height: 'auto', display: 'inline-block'}} data-google-query-id="CLLjtu_Vou4CFasPtwAdzesIUg">
                                    <div id="google_ads_iframe_/32866417/GamesQwik_320_100_1_0__container__" style={{border: '0pt none', width: '320px', height: '100px'}} /></div>
                            </center>
                        </div>
                        {/*  DPF END */}
                        <h3>Terms of Use</h3>
      ...
      <p>Any claim relating to PiKoYa L.T.D's web site shall be governed by the laws of the State of Haifa, Israel without regard to its conflict of law provisions.</p>
      <p>General Terms and Conditions applicable to Use of a Web Site.</p></span>
                        {/* TOP_MIDDLE_728X90 Banner */}{/* DFP */}
                        <div className="bnr_728">
                            <center>
                                <div id="div-8" style={{width: 'auto', height: 'auto', display: 'inline-block'}} data-google-query-id="CLTjtu_Vou4CFasPtwAdzesIUg">
