...
const Policy = () => {
    ...
    return (
        ...
        <p>Pikoya ("us", "we", or "our") operates the www.gamesqwik.com website (hereinafter referred to as the "Service").</p>
        <p>This page informs you of our policies regarding the collection, use and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
        <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from <a
            href="https://www.gamesqwik.com/terms">https://www.gamesqwik.com/terms</a></p><h2>Definitions</h2>
        <ul>
          <li>
            <p><strong>Service</strong></p>
            <p>Service is the www.gamesqwik.com website operated by Pikoya</p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            <p>Piwik or Matomo is a web analytics service. You can visit their Privacy Policy page here: <a
                href="https://matomo.org/privacy-policy">https://matomo.org/privacy-policy</a></p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>Statcounter is a web traffic analysis tool. You can read the Privacy Policy for Statcounter here: <a
                href="https://statcounter.com/about/legal/">https://statcounter.com/about/legal/</a></p>
          </li>
          <li>
            <p><strong>Mixpanel</strong></p>
            <p>Mixpanel is provided by Mixpanel Inc</p>
            <p>You can prevent Mixpanel from using your information for analytics purposes by opting-out. To opt-out of Mixpanel service, please visit this page: <a
                href="https://mixpanel.com/optout/">https://mixpanel.com/optout/</a></p>
            <p>For more information on what type of information Mixpanel collects, please visit the Terms of Use page of Mixpanel: <a
        ...
        <ul>
          <li>
            ...
            <p>You may opt out of the use of the DoubleClick Cookie for interest-based advertising by visiting the Google Ads Settings web page: <a
          ...
          <li>
            ...
            <p>You can opt-out of Bing Ads remarketing by visiting: <a
                href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads">https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</a></p>
            <p>For more information about Bing Ads, please visit their Privacy Policy: <a
                href="https://privacy.microsoft.com/en-us/PrivacyStatement">https://privacy.microsoft.com/en-us/PrivacyStatement</a></p>
          </li>
          <li>
            <p><strong>StartApp</strong></p>
            <p>StartApp is provided by StartApp, Inc.</p>
            <p>You can opt-out from interest-based ads served by StartApp by following the instructions on their Privacy Policy, section "8. Your Choices and Controls": <a
                href="https://www.startapp.com/policy/privacy-policy/">https://www.startapp.com/policy/privacy-policy/</a></p>
            <p>For more information on what information StartApp collects and how it is used, please read their Privacy Policy: <a
                href="https://www.startapp.com/policy/privacy-policy/">https://www.startapp.com/policy/privacy-policy/</a></p>
          </li>
          <li>
            <p><strong>AdButler</strong></p>
            <p>AdButler is an advertising service provided by Sparklit Networks, Inc.</p>
            <p>For more information about AdButler, please visit their Privacy Policy: <a
                href="https://www.sparklit.com/agreements.spark?agreement=privacy">https://www.sparklit.com/agreements.spark?agreement=privacy</a></p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>You can opt-out of Google Analytics for Display Advertising and customise the Google Display Network ads by visiting the Google Ads Settings page: <a
            ...
            <p>Google also recommends installing the Google Analytics Opt-out Browser Add-on - <a
                href="https://tools.google.com/dlpage/gaoptout">https://tools.google.com/dlpage/gaoptout</a> - for your web browser. Google Analytics Opt-out Browser Add-on provides visitors with the ability to prevent their data from being collected and used by Google Analytics.</p>
          ...
          <li>
            ...
            <p>You can opt-out from Twitter's interest-based ads by following their instructions: <a
                href="https://support.twitter.com/articles/20170405">https://support.twitter.com/articles/20170405</a></p>
            <p>You can learn more about the privacy practices and policies of Twitter by visiting their Privacy Policy page: <a
          ...
          <li>
            ...
            <p>You can learn more about interest-based advertising from Facebook by visiting this page: <a
                href="https://www.facebook.com/help/164968693837950">https://www.facebook.com/help/164968693837950</a></p>
            <p>To opt-out from Facebook's interest-based ads, follow these instructions from Facebook:  <a
                href="https://www.facebook.com/help/568137493302217">https://www.facebook.com/help/568137493302217</a></p><p>
            </p><p>Facebook adheres to the Self-Regulatory Principles for Online Behavioural Advertising established by the Digital Advertising Alliance. You can also opt-out from Facebook and other participating companies through the Digital Advertising Alliance in the USA <a
              href="http://www.aboutads.info/choices/">http://www.aboutads.info/choices/</a>, the Digital Advertising Alliance of Canada in Canada <a
              href="http://youradchoices.ca/">http://youradchoices.ca/</a> or the European Interactive Digital Advertising Alliance in Europe <a
              href="http://www.youronlinechoices.eu/">http://www.youronlinechoices.eu/</a>, or opt-out using your mobile device settings.</p>
          ...
          <li>
            ...
            <p>You can opt-out from Pinterest's interest-based ads by enabling the "Do Not Track" functionality of your web browser or by following Pinterest instructions: <a
                href="http://help.pinterest.com/en/articles/personalization-and-data">http://help.pinterest.com/en/articles/personalization-and-data</a></p>
            <p>You can learn more about the privacy practices and policies of Pinterest by visiting their Privacy Policy page: <a
                href="https://about.pinterest.com/en/privacy-policy">https://about.pinterest.com/en/privacy-policy</a></p>
          </li>
          <li>
            ...
            <p>You can opt-out of AdRoll remarketing by visiting this AdRoll Advertising Preferences web page: <a
                href="http://info.evidon.com/pub_info/573?v=1&nt=1&nw=false">http://info.evidon.com/pub_info/573?v=1&amp;nt=1&amp;nw=false</a></p>
            <p>For more information on the privacy practices of AdRoll, please visit the AdRoll Privacy Policy web page: <a
                href="http://www.adroll.com/about/privacy">http://www.adroll.com/about/privacy</a></p>
          </li>
          <li>
            <p><strong>Perfect Audience</strong></p>
            <p>Perfect Audience remarketing service is provided by NowSpots Inc.</p>
            <p>You can opt-out of Perfect Audience remarketing by visiting these pages: Platform Opt-out (<a
                href="http://pixel.prfct.co/coo">http://pixel.prfct.co/coo</a>) and Partner Opt-out (<a
                href="http://ib.adnxs.com/optout">http://ib.adnxs.com/optout</a>).</p>
            <p>For more information on the privacy practices of Perfect Audience, please visit the Perfect Audience Privacy Policy &amp; Opt-out web page: <a
                href="https://www.perfectaudience.com/privacy/index.html">https://www.perfectaudience.com/privacy/index.html</a></p>
          </li>
          <li>
            <p><strong>AppNexus</strong></p>
            <p>AppNexus remarketing service is provided by AppNexus Inc.</p>
            <p>You can opt-out of AppNexus remarketing by visiting the Privacy &amp; the AppNexus Platform web page: <a
                href="http://www.appnexus.com/platform-policy#choices">http://www.appnexus.com/platform-policy#choices</a></p>
            <p>For more information on the privacy practices of AppNexus, please visit the AppNexus Platform Privacy Policy web page: <a
                href="http://www.appnexus.com/platform-policy/">http://www.appnexus.com/platform-policy/</a></p>
          </li>
        </ul>
        ...
        <ul>
          <li>By visiting this page on our website: <a
              href="https://www.gamesqwik.com/contact">https://www.gamesqwik.com/contact</a></li>
